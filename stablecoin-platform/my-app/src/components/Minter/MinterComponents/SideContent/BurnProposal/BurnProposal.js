...
import FormBurnProposal from "./../Forms/FormBurnProposal.js";


class BurnProposal extends Component {
    ...
    return (
      <div className={Style.app}>
        ...
        onClick={() => this.toggle(1)}>
          <span className={Style.app__toggle__text}>Burn Proposal</span>
        </button>
        ...
        className={Style.app__collapse + " " + Style.app__collapse__gradient + " " + (this.state.display ? Style.app__collapse__active : "")}>
          <FormBurnProposal web3={this.props.web3} contract={this.props.contract}/>
        </Collapse>
      </div>
    )
  }

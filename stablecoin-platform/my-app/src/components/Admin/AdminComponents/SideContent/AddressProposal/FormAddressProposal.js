...
export default class FormAddressProposal extends Component {
    ...
    userSchema = Yup.object().shape({
        ...
        Operation: Yup.string()
            .required("Required")
            .oneOf(["setWhiteListing","setLock"],"Not a valid operation"),
    ...
    submit = (values, actions) => {
        this.props.web3.eth.getAccounts().then((accounts) => {
            ...
            this.props.contract.methods.createAddressProposal(Web3.utils.fromAscii(values["Operation"]), Web3.utils.fromAscii(values["ProposalId"]),values["AddressTo"],values["State"],values["AddressContract"]).send({ from: accounts[0] });
                    ...
                    {({ handleSubmit, isSubmitting }) => (
                        <form onSubmit={handleSubmit} className={Style.formContainer}>
                            ...
                            <Field
                                ...
                                as="select" 
                                name="Operation"
                                placeholder="setLock or setWhiteListing">
                                <option value="setLock">Set Lock</option>
                                <option value="setWhiteListing">Set Whitelisting</option>                                
                            </Field>

...
export default class FormTransferProposal extends Component {
    ...
    submit = (values, actions) => {
        this.props.web3.eth.getAccounts().then((accounts) => {
            this.props.contract.methods.createTransferProposal(Web3.utils.fromAscii(values["ProposalId"]),values["Amount"],values["AddressTo"],values["AddressFrom"],values["State"],values["AddressContract"]).send({ from: accounts[0] });

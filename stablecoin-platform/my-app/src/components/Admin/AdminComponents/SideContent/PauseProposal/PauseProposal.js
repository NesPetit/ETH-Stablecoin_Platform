...
import FormPauseProposal from "./FormPauseProposal.js";

class PauseProposal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      display: false
  ...
  render() {
    return (
        ...
        >
          <span className={Style.app__toggle__text}>Pause Proposal</span>
        </button>
        <Collapse
        ...
        >
          <FormPauseProposal web3={this.props.web3} contract={this.props.contract}/>
        </Collapse>
      </div>
    )}
}

export default PauseProposal;